...
//{				
  //Eigen::Vector3	f pos_vector = viewer_pose * Eigen::Vector3f (0, 0, 0	);	
  //Eigen::Vector3	f look_at_vector = viewer_pose.rotation () * Eigen::Vector3f (0, 0, 1	) + pos_vector;	
  //Eigen::Vector3	f up_vector = viewer_pose.rotation () * Eigen::Vector3f (0, -1, 0	);	
...
{				
  ...
  // --------------------------------------------				
  // -----Open 3	D viewer and add point cloud-----			
  // --------------------------------------------				
  ...
  //viewer.addCoordinateSystem (1.0	f, "global");			
